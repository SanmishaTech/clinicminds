...
import { ACTIVE_ROLE_LABELS, ROLES_PERMISSIONS, ROLES } from '@/config/roles';
...
interface SearchableItem extends NavLeafItem {
 ...
 const ACTIVE_ROLE_LABEL_SET = new Set(
...
export function GlobalSearch() {
  ...
  const searchableItems = useMemo(() => {
    ...
    const resolvedRoleLabel = (ROLES as any)[user.role] || user.role;
    const roleLabel = ACTIVE_ROLE_LABEL_SET.has(resolvedRoleLabel)
      ? resolvedRoleLabel
      : ROLES.DOCTOR;
