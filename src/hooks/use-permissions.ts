...
import { ACTIVE_ROLE_LABELS, ROLES_PERMISSIONS, PERMISSIONS, ROLES } from '@/config/roles';
...
export function usePermissions(): UsePermissionsResult {
  ...
  const { perms, permSet } = useMemo(() => {
    ...
    function resolveRoleLabel(value: string): string {
      ...
      return ACTIVE_ROLE_LABEL_SET.has(resolved) ? resolved : ROLES.DOCTOR;
    }
