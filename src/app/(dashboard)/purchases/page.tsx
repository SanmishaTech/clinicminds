...
export default function PurchasesPage() {
  ...
  if (error) {
    toast.error((error as Error).message || 'Failed to load Purchases');
  }
  ...
  return (
    <AppCard>
      <AppCard.Header>
        <AppCard.Title>Purchases</AppCard.Title>
        <AppCard.Description>Manage Purchases</AppCard.Description>
