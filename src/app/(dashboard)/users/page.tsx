...
import { ACTIVE_ROLE_CODES, PERMISSIONS, ROLES } from '@/config/roles';
...
export default function UsersPage() {
	...
	const columns: Column<UserListItem>[] = [
		...
		},
		{
			...
			header: 'Role',
			sortable: true,
			accessor: (r) => <span className='whitespace-nowrap'>{(ROLES as any)[r.role] ?? r.role}</span>,
				...
				<FilterBar title='Search & Filter'>
					...
					<AppCombobox
						...
						options={[
							...
							...(ACTIVE_ROLE_CODES as readonly string[]).map((code) => ({
								value: code,
