...
export const ROLES_PERMISSIONS = {
  ...
  [ROLES.ADMIN]: (Object.values(PERMISSIONS) as string[]).filter(
    (p) =>
      ...
      p !== PERMISSIONS.READ_ROOMS &&
      p !== PERMISSIONS.CREATE_ROOMS &&
      p !== PERMISSIONS.EDIT_ROOMS &&
      p !== PERMISSIONS.DELETE_ROOMS &&
      p !== PERMISSIONS.VIEW_ROOMS &&
      p !== PERMISSIONS.READ_TEAMS &&
      p !== PERMISSIONS.CREATE_TEAMS &&
      p !== PERMISSIONS.EDIT_TEAMS &&
      p !== PERMISSIONS.DELETE_TEAMS &&
      p !== PERMISSIONS.VIEW_TEAMS
  ),
  [ROLES.FRANCHISE]: [
